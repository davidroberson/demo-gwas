...
- id: null_model_r
  ...
  - id: norm_bygroup
    source: norm_bygroup
  run: null_model.cwl.steps/null_model_r.cwl
  out:
  - id: configs
  - id: null_model_phenotypes
  - id: null_model_files
...
- id: null_model_report
  ...
  run: null_model.cwl.steps/null_model_report.cwl
  out:
  - id: html_reports
  - id: rmd_files
...
sbg:original_source: dave/build-demo-gwas-workflows/null-model/0
