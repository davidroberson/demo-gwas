...
- id: define_segments_r
  ...
  - id: genome_build
    source: genome_build
  run: single_variant_association_testing.cwl.steps/define_segments_r.cwl
  out:
  - id: config
...
- id: assoc_single_r
  ...
  run: single_variant_association_testing.cwl.steps/assoc_single_r.cwl
  out:
  - id: configs
  - id: assoc_single
  sbg:x: 410
...
- id: assoc_combine_r
  ...
  - assoc_files
  scatterMethod: dotproduct
  run: single_variant_association_testing.cwl.steps/assoc_combine_r.cwl
  out:
  - id: assoc_combined
  - id: configs
  sbg:x: 1087
...
- id: assoc_plots_r
  ...
  run: single_variant_association_testing.cwl.steps/assoc_plots_r.cwl
  out:
  - id: assoc_plots
  - id: configs
  - id: Lambdas
...
- id: sbg_gds_renamer
  ...
  scatter:
  - in_variants
  run: single_variant_association_testing.cwl.steps/sbg_gds_renamer.cwl
  out:
  - id: renamed_variants
...
- id: sbg_flatten_lists
  ...
  run: single_variant_association_testing.cwl.steps/sbg_flatten_lists.cwl
  out:
  - id: output_list
  sbg:x: 684.666015625
...
- id: sbg_prepare_segments_1
  ...
  run: single_variant_association_testing.cwl.steps/sbg_prepare_segments_1.cwl
  out:
  - id: gds_output
  - id: segments
  - id: aggregate_output
...
- id: sbg_group_segments_1
  ...
  run: single_variant_association_testing.cwl.steps/sbg_group_segments_1.cwl
  out:
...
sbg:original_source: dave/build-demo-gwas-workflows/single-variant-association-testing/0
